...
### Conference Rates
*Conference rates have been substantially reduced compared to 2012 rates and this follows significant reductions over recent years*

<div class="panel">
      <h5>Sterling equivalent rates</h5>
      <p>Please note that while prices are quoted in Sterling below, these are only equivalent prices as of 30/01/2013. <b>All payments will be processed in Euro only. Please note registration has now closed </b></p>
</div>
...
<ul class="pricing-table">
  ...
  <li class="cta-button"><a class="button radius success" href="http://">Buy it Now &raquo;</a>
  </li>
</ul>
...
<ul class="pricing-table">
  ...
  <li class="bullet-item">Choice of Fieldtrip on 2nd Day.</li>
  <li class="cta-button"><a class="button radius alert" href="http:">Buy it Now &raquo;</a>
  </li>
</ul>
</div> 
...
<li class="description">This is entitles a member to attend a single day of the conference as indicated at time of purchase.</li>
  ...
  <li class="bullet-item">RTPI, Urban Forum Members and Councillors</li>
  <li class="bullet-item">Admission to Conference Dinner included.</li>
  <li class="cta-button"><a class="button radius" href="http://www.">Buy it Now &raquo;</a>
  </li>
</ul>
</div>
...
<ul class="pricing-table">
  ...
  <li class="bullet-item">Admission to Conference Dinner included.</li>
  <li class="cta-button"><a class="button radius alert" href="http://www.">Buy it Now &raquo;</a>
  </li>
</ul>
</div>
<hr />
...
<ul class="pricing-table">
  ...
  <li class="cta-button"><a class="button radius success" href="http://www.">Buy it Now &raquo;</a>
  </li>
</ul>
...
<ul class="pricing-table">
  ...
  <li class="cta-button"><a class="button radius alert" href="http://www.W">Buy it Now &raquo;</a>
  </li>
</ul>
**Places are allocated on a first come, first served basis.**
<hr/>